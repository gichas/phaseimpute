...
// Impute5 subworkflows
include {VCFCHREXTRACT as VCFCHREXTRACT_IMPUTE5      } from '../../modules/local/vcfchrextract'
include {VCF_SPLIT_BYCHROMOSOME as VCF_SPLIT_BYCHROMOSOME_IMPUTE5} from '../../modules/local/vcfsplitbychr'
